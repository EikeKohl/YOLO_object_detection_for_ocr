...
def make_yolov3_model():
    input_image = Input(shape=(768, 768, 1))
    ...
    x = UpSampling2D(2)(x)
    print(x.shape)
    print("Concatenation with skip_61!")
    ...
    x = UpSampling2D(2)(x)
    print(x.shape)
    print("Concatenation with skip_36!")
